...
<section id="perguntas-f" class="container grid-2">
    ...
    <div class="caixas-perguntas">
        <ul>
            <li>
                <div class="titulo-caixa-p">
                    <button>
                    <h4><span>1.</span>Como o projeto 'Forsaken Dogs' garante que as doações em dinheiro serão utilizadas de forma responsável?</h4>
                    </button>
                    <div class="texto">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere doloribus optio, cupiditate
                            consequuntur suscipit nulla explicabo facilis tenetur in, exercitationem, a eveniet mollitia
                            consectetur dolor eligendi praesentium voluptatum sint voluptate.</p>
                    </div>
                </div>
            </li>
            <li>
                <div class="titulo-caixa-p">
                    <button>
                    <h4><span>2.</span>Como o projeto 'Forsaken Dogs' garante que as doações em dinheiro serão utilizadas de forma responsável?</h4>
                    </button>
                    <div class="texto">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere doloribus optio, cupiditate
                            consequuntur suscipit nulla explicabo facilis tenetur in, exercitationem, a eveniet mollitia
            ...
            <li>
                <div class="titulo-caixa-p">
                    <button>
                    <h4><span>3.</span>Como o projeto 'Forsaken Dogs' garante que as doações em dinheiro serão utilizadas de forma responsável?</h4>
                    </button>
                    <div class="texto">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere doloribus optio, cupiditate
                            consequuntur suscipit nulla explicabo facilis tenetur in, exercitationem, a eveniet mollitia
